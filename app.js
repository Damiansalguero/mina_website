...
const workshopflyerRoutes = require("./routes/wsflyers");
const workshopThreeRoutes = require("./routes/workshopsthree");
...
const timelinefourRoutes = require("./routes/timelinesfour");
...
app.use("/workshop-flyer", workshopflyerRoutes);
app.use("/workshops2022", workshopThreeRoutes);
...
app.use("/zeitstrahl2024", timelinefourRoutes);
